package com.musiclock.ui.lockscreen
...
import com.musiclock.ui.lockscreen.skin.SkinOrientation

/**
 * Activity shown over the keyguard when music is playing. It is purely a host: it configures the
 * show-when-locked window flags, wires the selected [com.musiclock.ui.lockscreen.skin.PlayerSkin] to
